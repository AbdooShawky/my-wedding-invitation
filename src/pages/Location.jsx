            ...
            <div className="container mx-auto px-4 py-20 relative z-10">
                ...
                >
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="text-4xl inline-block text-rose-500 font-medium"
                    >
                        دار المركبات
                    </motion.h2>
                    ...
                    <motion.h4
                        ...
                        viewport={{ once: true }}
                        className="text-3xl md:text-3xl font-serif text-gray-800"
                    >
                        7 sky
                    </motion.h4>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start space-x-4">
                                    <MapPin className="w-5 h-5 text-rose-500 mt-1 ml-2" />
                                    <p className="text-gray-600 flex-1">{config.data.address}</p>
                                </div>

                                <div className="flex items-center space-x-4">
                                    <CalendarCheck className="w-5 h-5 text-rose-500 ml-2" />
                                    <p className="text-gray-600">الثلاثاء، 24 ديسمبر 2024</p>
                                </div>

                                <div className="flex items-center space-x-4">
                                    <Clock className="w-5 h-5 text-rose-500 ml-2" />
                                ...
                                <div className="pt-4">
                                    ...
                                    >
                                        ...
                                        <span className="font-semibold"> عرض الموقع على الخريطة</span>
                                    </motion.a>
                                </div>
                            </div>
                        </div>
